...
ActiveRecord::Schema[7.1].define(version: 2024_05_29_182008) do
  ...
  create_table "inn_bookings", force: :cascade do |t|
    t.integer "inn_id", null: false
    t.string "name"
    t.date "start_date"
    t.date "end_date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inn_id"], name: "index_inn_bookings_on_inn_id"
  end
  ...
  add_foreign_key "inn_bookings", "inns"
